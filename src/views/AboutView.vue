...
.homePage{
  left:-50rem;
  animation: slide-profile 1s ease-in-out;
  position: absolute;
}
...
.about {
  ...
  width: 80vh;
  height: 25vh;
  animation: slide-background 1s ease-in-out;
  position: absolute;
